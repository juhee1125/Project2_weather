...
<body>
<form id="editForm" action="/board/edit" method="post" enctype="multipart/form-data">
        ...
        <div class="board_write_wrap">
            <div class="board_write">
                <div class="title">
                    <dl>
                        <dt>제목</dt>
                        <dd><input type="hidden" name="num" value="${boardNum.num}"/>
                        <input type="hidden" name="postdate" value="${boardNum.postdate}"/>
                        <input type="text" name="title" value="${boardNum.title}"/>
                        <input type="hidden" name="likecount" value="${boardNum.likecount}"/></dd>
                    </dl>
                </div>
                <div class="info">
                    <dl>
                    ...
                    <dl>
                        <dt></dt>
                        <dd><input type="hidden"  name="id" value="${boardNum.id}">
                        <input type="hidden"  name="pw" value="${boardNum.pw}"></dd>
                    </dl>
                </div>
